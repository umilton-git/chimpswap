    ...
    loadMigrate(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { artifacts } = yield this.run(LoadMigrate.process, {
                ...
                artifacts: options.artifacts.map((artifact, index) => (Object.assign(Object.assign({}, artifact), { networks: Object.assign(Object.assign({}, artifact.networks), { [networkId]: Object.assign(Object.assign({}, (artifact.networks || {})[networkId]), { db: {
                                network: networks[index] || resources_1.toIdObject(network.knownLatest)
                            } }) }) })))
            });
            return {
