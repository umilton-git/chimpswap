    ...
    try {
        for (var extensions_1 = tslib.__values(extensions), extensions_1_1 = extensions_1.next(); !extensions_1_1.done; extensions_1_1 = extensions_1.next()) {
            ...
            if (path.endsWith(formattedExtension)) {
                if (ignoredExtensions) {
                    try {
                        for (var ignoredExtensions_2 = (e_6 = void 0, tslib.__values(ignoredExtensions)), ignoredExtensions_2_1 = ignoredExtensions_2.next(); !ignoredExtensions_2_1.done; ignoredExtensions_2_1 = ignoredExtensions_2.next()) {
